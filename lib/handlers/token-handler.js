...
var grantTypes = {
  ...
  'urn:ietf:params:oauth:grant-type:jwt-bearer': require('../grant-types/jwt-bearer')
};
  ...
  return Promise.bind(this)
    ...
    .tap(function (data) {
      ...
      if (!Boom.isBoom(e)) {
        ...
        Boom.boomify(e, { statusCode: e.code });
      }
...
TokenHandler.prototype.getClient = function (request, response) {
  ...
  if (this.isClientAuthenticationRequired(grantType) && !is.vschar(credentials.clientSecret)) {
    throw new InvalidRequestError('Invalid parameter: `client_secret`');
  }

  return promisify(this.model.getClient, 2)(credentials, request)
    .then(function (client) {
      if (!client) {
